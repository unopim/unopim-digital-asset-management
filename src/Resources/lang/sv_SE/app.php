...
return [
        ...
        'dam' => [
            ...
            'index' => [
                ...
                'directory' => [
                    ...
                    'actions' => [
                        ...
                        'upload-files-and-folders'  => 'Ladda upp filer och mappar',
                        'upload-folder'             => 'Ladda upp mapp',
                        'upload-drop-hint'          => 'Dra filer eller mappar hit',
                        'upload-or'                 => 'eller bläddra:',
                ...
                'folder-upload-no-https-warning' => 'Tomma mappar skapas inte utan en säker anslutning (HTTPS). Filer laddas fortfarande upp.',
            ...
            'asset' => [
                ...
                'edit' => [
                    ...
                    'share' => [
                        ...
                        'expiry-7d'  => '7 dagar',
                        'expiry-30d' => '30 dagar',
                        'expires-on' => 'Upphör den',
                        'failed'     => 'Det gick inte att generera delningslänk.',
                    ],
                    'preview-modal' => [
            ...
            'share' => [
                ...
                'modal'            => [
                    ...
                    'loading'            => 'Läser in…',
                    'no-active-links'    => 'Inga aktiva delningslänkar för det här objektet ännu.',
                    'copy'               => 'Kopiera',
                    'copied'             => 'Länk kopierad till urklipp',
                    'revoke'             => 'Återkalla',
                    'delete'             => 'Delete',
                    ...
                    'advanced'           => 'Avancerat',
                    'revoked-status'     => 'Länk återkallad',
    ...
    'share' => [
        'public' => [
            ...
            'video-not-supported'   => 'Din webbläsare stöder inte video-elementet.',
            'audio-not-supported'   => 'Din webbläsare stöder inte audio-elementet.',
    ...
    'data-transfer' => [
        'bundle' => [
            ...
            'asset-tree-misnamed'        => 'Arkivet innehåller en mapp med namnet ":name" i stället för "assets", så inga av dess tillgångar kunde importeras. Byt namn till "assets" och låt mapparna under den motsvara sökvägarna i din datafil, till exempel "assets/Root/Seed/Tech Sheets/Cotton/". macOS sparar ett "/" som skrivs i ett mappnamn som ":", vilket är den vanliga orsaken.',
        ],
    ],
];
