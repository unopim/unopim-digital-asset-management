...
return [
    'admin' => [
        ...
        'configuration' => [
            ...
            'general'  => [
                'title'            => '一般設定',
                'description'      => 'DAMメディアライブラリのディレクトリツリーの表示、エクスプローラービュー、ブックマークパネルを設定します。',
                'tree-show-assets' => [
                    'label' => 'ディレクトリツリーにアセットを表示',
                    'hint'  => '有効にすると、アセットファイルがディレクトリツリーのリーフノードとして表示されます。',
                ],
                'explorer-enabled' => [
                    'label' => 'エクスプローラービューを有効にする',
                    'hint'  => 'デフォルトのアセットグリッドをマルチタブフォルダーエクスプローラーに置き換えます。',
                ],
                'bookmarks-enabled' => [
                    'label' => 'ブックマークパネルを有効にする',
                    'hint'  => 'ディレクトリツリーの下にブックマークパネルを表示し、素早くナビゲーションできます。',
                ],
                'show-tree' => [
                    'label' => 'ディレクトリツリーを表示',
                    'hint'  => '有効にすると、エクスプローラーの横にディレクトリツリーのサイドバーが表示されます。',
                ],
            ],
        ],
        'explorer' => [
