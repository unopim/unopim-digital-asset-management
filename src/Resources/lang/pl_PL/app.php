...
return [
    'admin' => [
        ...
        'dam' => [
            ...
            'share' => [
                ...
                'delete-failed'    => 'Nie udało się usunąć linku udostępniania.',
                'modal'            => [
            ...
            'upload' => [
                ...
                'retry'     => 'Ponów',
                'cancel'    => 'Anuluj',
                'paused'    => 'Przesyłanie wstrzymane. Istniejące zasoby pozostają nienaruszone — wznów w dowolnym momencie.',
                'resumed'   => 'Przesyłanie wznowione.',
                'cancelled' => 'Przesyłanie anulowane. Już przesłane zasoby zostały zachowane.',
                'retried'   => 'Ponawianie nieudanych przesyłań w tle.',
            ],
            'tag' => [
                'not-found'           => 'Nie znaleziono tagu.',
                'create-success'      => 'Tag został pomyślnie utworzony.',
                'update-success'      => 'Tag został pomyślnie zaktualizowany.',
                'delete-success'      => 'Tag został pomyślnie usunięty.',
                'mass-delete-success' => 'Wybrane tagi zostały pomyślnie usunięte.',
                'index'               => [
                    'title'       => 'Tagi',
                    'description' => 'Zarządzaj tagami używanymi do etykietowania i organizowania zasobów w DAM.',
                    'create'      => 'Utwórz tag',
                ],
                'datagrid' => [
                    'name'         => 'Nazwa',
                ...
                'modal' => [
                    'create-title'     => 'Utwórz tag',
                    'edit-title'       => 'Edytuj tag',
                    'name-label'       => 'Nazwa tagu',
                    'name-placeholder' => 'np. kampania-letnia',
                    'save'             => 'Zapisz',
                    'saving'           => 'Zapisywanie…',
                    'cancel'           => 'Anuluj',
                ],
                'mass-action' => [
                    ...
                    'modal-title'              => 'Przypisz tagi',
                    'modal-subtitle'           => 'Dodaj tagi do :count wybranego(ych) zasobu(ów). Istniejące tagi zostają zachowane.',
                    'modal-subtitle-recursive' => 'Dodaj tagi do wybranych zasobów oraz do wszystkich zasobów w wybranych folderach, rekurencyjnie. Istniejące tagi zostają zachowane.',
                    'tags-label'               => 'Tagi',
                    'tags-placeholder'         => 'Wyszukaj tagi lub wpisz, aby utworzyć…',
                    'add-tag'                  => 'Naciśnij Enter, aby dodać',
                    'assign'                   => 'Przypisz',
                    'assigning'                => 'Przypisywanie…',
                    'cancel'                   => 'Anuluj',
                    'assign-success'           => 'Tagi przypisane do :count zasobu(ów).',
                    'assign-failed'            => 'Nie udało się przypisać tagów.',
                    'no-assets'                => 'Nie wybrano żadnych zasobów.',
                    'no-items'                 => 'Wybierz co najmniej jeden zasób lub folder.',
                    'no-tags'                  => 'Wybierz lub dodaj co najmniej jeden tag.',
                ],
            ],
        ],
        'catalog' => [
        ...
        'acl' => [
            ...
            'comment'          => 'Komentarz',
            'linked_resources' => 'Powiązane zasoby',
            'meta_data'        => 'Osadzone informacje meta',
            'directory'        => 'Katalog',
            'tag'              => 'Tag',
            'create'           => 'Utwórz',
            'edit'             => 'Edytuj',
        ...
        'permissions' => [
            ...
            'loading'               => 'Ładowanie katalogów…',
            'empty'                 => 'Nie znaleziono katalogów.',
            'error'                 => 'Nie udało się załadować katalogów. Spróbuj ponownie.',
            'retry'                 => 'Ponów',
            'grants-load-warning'   => 'Nie udało się załadować niektórych uprawnień do katalogów. Przed zapisaniem zweryfikuj swoje wybory.',
            'inherit-children-note' => 'Podkatalogi zostaną uwzględnione automatycznie podczas zapisywania.',
        ],
        'validation' => [
            'asset' => [
        ...
        'explorer' => [
            ...
            'context' => [
                ...
                'copy'                 => 'Kopiuj',
                'paste'                => 'Wklej',
                'copy-progress'        => 'Kopiowanie w kolejce.',
                'copy-done'            => 'Skopiowano.',
                'paste-file-started'   => 'Wklejanie pliku...',
                'paste-folder-started' => 'Wklejanie folderu...',
                'paste-done'           => 'Wklejono pomyślnie.',
                'move-asset-started'   => 'Przenoszenie pliku...',
            ...
            'mass-actions' => [
                'select-count'   => ':count zaznaczono',
                'select-action'  => 'Wybierz akcję',
                'delete'         => 'Usuń',
                'confirm'        => 'Usunąć :count element(y)? Foldery zostaną usunięte rekurencyjnie i nie można tego cofnąć.',
                'deleting'       => 'Usuwanie :count elementu(ów)...',
                'deleted-assets' => ':count zasób(y) usunięty(e).',
                'deleted-dirs'   => ':count folder(y) w kolejce do usunięcia.',
                'move-to'        => 'Przenieś do…',
                'copy-to'        => 'Kopiuj do…',
                'moving'         => 'Przenoszenie…',
                'copying'        => 'Kopiowanie…',
                'moved-assets'   => ':count plik(i) przeniesiono.',
                'copied-assets'  => ':count plik(i) skopiowano.',
                'moved-dirs'     => ':count folder(y) przeniesiono.',
                'copied-dirs'    => ':count folder(y) skopiowano.',
                'pick-dest'      => 'Wybierz miejsce docelowe',
                'select-here'    => 'Wybierz tutaj',
                'new-folder'     => 'Nowy folder',
                'folder-name'    => 'Nazwa folderu',
                'create-error'   => 'Nie można utworzyć folderu.',
                'move-done'      => ':count Pliki przeniesione.',
                'copy-done'      => ':count Pliki skopiowane.',
                'still-running'  => 'Operacja nadal działa w tle',
                'progress'       => 'Postęp',
                'total-files'    => ':count plik(ów)',
            ],
            'toolbar' => [
            ...
            'upload' => [
                'queued'              => 'W kolejce',
                'uploading'           => 'Przesyłanie',
                'creating'            => 'Tworzenie folderu',
                'done'                => 'Gotowe',
                'failed'              => 'Niepowodzenie',
                'interrupted'         => 'Przerwano — dodaj ponownie, aby spróbować jeszcze raz',
                'resuming'            => 'Wznawianie…',
                'overall'             => 'Przesłano :done z :total',
                'too-large-to-resume' => 'Partia zbyt duża, aby automatycznie wznowić po odświeżeniu',
            ],
        ],
    ],
    'share' => [
    ...
    'data-transfer' => [
        'bundle' => [
            ...
            'asset-tree-misnamed'        => 'Archiwum zawiera folder o nazwie ":name" zamiast "assets", więc nie udało się zaimportować żadnego z jego zasobów. Zmień jego nazwę na "assets" i zachowaj foldery poniżej zgodne ze ścieżkami w pliku danych, np. "assets/Root/Seed/Tech Sheets/Cotton/". macOS zapisuje znak "/" wpisany w nazwie folderu jako ":", co jest typową przyczyną.',
        ],
    ],
];
