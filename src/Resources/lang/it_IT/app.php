...
return [
    'admin' => [
        ...
        'dam' => [
            ...
            'index' => [
                ...
                'delete' => [
                    'directory' => 'Eliminazione della directory ":name"…',
                ],
            ],
            'asset' => [
                'properties' => [
            ...
            'upload' => [
                ...
                'retry'     => 'Riprova',
                'cancel'    => 'Annulla',
                'paused'    => 'Caricamento sospeso. Le risorse esistenti non sono state modificate — riprendi in qualsiasi momento.',
                'resumed'   => 'Caricamento ripreso.',
                'cancelled' => 'Caricamento annullato. Le risorse già caricate sono state mantenute.',
                'retried'   => 'Nuovo tentativo dei caricamenti falliti in background.',
            ],
            'tag' => [
                'not-found'           => 'Tag non trovato.',
                ...
                'mass-delete-success' => 'Tag selezionati eliminati con successo.',
                'index'               => [
                    'title'       => 'Tag',
                    'description' => 'Gestisci i tag utilizzati per etichettare e organizzare le risorse nel DAM.',
                    'create'      => 'Crea tag',
                ],
                'datagrid' => [
                    'name'         => 'Nome',
                    'assets-count' => 'Risorse',
                    'created-at'   => 'Creato il',
                    'edit'         => 'Modifica',
                    'delete'       => 'Elimina',
                ],
                'modal' => [
                    ...
                    'name-label'       => 'Nome del tag',
                    'name-placeholder' => 'es. campagna-estiva',
                    'save'             => 'Salva',
                    'saving'           => 'Salvataggio…',
                    'cancel'           => 'Annulla',
                ],
                'mass-action' => [
                    ...
                    'modal-title'              => 'Assegna tag',
                    'modal-subtitle'           => 'Aggiungi tag a :count risorsa/e selezionata/e. I tag esistenti vengono mantenuti.',
                    'modal-subtitle-recursive' => 'Aggiungi tag alle risorse selezionate e a tutte le risorse all\'interno delle cartelle selezionate, in modo ricorsivo. I tag esistenti vengono mantenuti.',
                    'tags-label'               => 'Tag',
                    'tags-placeholder'         => 'Cerca tag o digita per crearne uno…',
                    'add-tag'                  => 'Premi Invio per aggiungere',
                    'assign'                   => 'Assegna',
                    'assigning'                => 'Assegnazione in corso…',
                    'cancel'                   => 'Annulla',
                    'assign-success'           => 'Tag assegnati a :count risorsa/e.',
                    'assign-failed'            => 'Impossibile assegnare i tag.',
                    'no-assets'                => 'Nessuna risorsa selezionata.',
                    'no-items'                 => 'Seleziona almeno una risorsa o una cartella.',
                    'no-tags'                  => 'Seleziona o aggiungi almeno un tag.',
                ],
            ],
        ],
        'catalog' => [
        ...
        'acl' => [
            ...
            'comment'          => 'Commento',
            'linked_resources' => 'Risorse Collegate',
            'meta_data'        => 'Informazioni meta incorporate',
            'directory'        => 'Directory',
            'tag'              => 'Tag',
            'create'           => 'Crea',
            'edit'             => 'Modifica',
        ...
        'permissions' => [
            ...
            'loading'               => 'Caricamento directory in corso…',
            'empty'                 => 'Nessuna directory trovata.',
            'error'                 => 'Impossibile caricare le directory. Riprovare.',
            'retry'                 => 'Riprova',
            'grants-load-warning'   => 'Alcune autorizzazioni sulle directory non sono state caricate correttamente. Verificare le selezioni prima di salvare.',
            'inherit-children-note' => 'Le sottodirectory verranno incluse automaticamente al salvataggio.',
        ],
        'validation' => [
            'asset' => [
        ...
        'explorer' => [
            ...
            'bookmarks' => [
                ...
                'max'       => 'Raggiunto il limite massimo di 20 segnalibri.',
                'remove'    => 'Rimuovi segnalibro',
                'empty'     => 'Ancora nessun segnalibro.',
            ],
            'tab' => [
                'new'   => 'Nuova scheda',
                'close' => 'Chiudi scheda',
            ...
            'context' => [
                ...
                'copy'                 => 'Copia',
                'paste'                => 'Incolla',
                'copy-progress'        => 'Copia in coda.',
                'copy-done'            => 'Copiato.',
                'paste-file-started'   => 'Incollando il file...',
                'paste-folder-started' => 'Incollando la cartella...',
                'paste-done'           => 'Incollato con successo.',
                'move-asset-started'   => 'Spostando il file...',
                'move-folder-started'  => 'Spostando la cartella...',
                'move-done'            => 'Cartella spostata con successo.',
                'move-asset-done'      => 'File spostato con successo.',
                'delete-done'          => 'Directory eliminata con successo.',
            ],
            'folder' => [
                'deleted' => 'Questa cartella è stata eliminata — tornato alla root.',
            ],
            'search' => [
            ...
            'mass-actions' => [
                'select-count'   => ':count selezionati',
                'select-action'  => 'Seleziona azione',
                'delete'         => 'Elimina',
                'confirm'        => 'Eliminare :count elemento/i? Le cartelle verranno eliminate ricorsivamente e l\'operazione non potrà essere annullata.',
                'deleting'       => 'Eliminazione di :count elemento/i in corso...',
                'deleted-assets' => ':count risorsa/e eliminata/e.',
                'deleted-dirs'   => ':count cartella/e messa/e in coda per l\'eliminazione.',
                'move-to'        => 'Sposta in…',
                'copy-to'        => 'Copia in…',
                'moving'         => 'Spostamento in corso…',
                'copying'        => 'Copia in corso…',
                'moved-assets'   => ':count file spostato/i.',
                'copied-assets'  => ':count file copiato/i.',
                'moved-dirs'     => ':count cartella/e spostata/e.',
                'copied-dirs'    => ':count cartella/e copiata/e.',
                'pick-dest'      => 'Seleziona destinazione',
                'select-here'    => 'Seleziona qui',
                'new-folder'     => 'Nuova cartella',
                'folder-name'    => 'Nome cartella',
                'create-error'   => 'Impossibile creare la cartella.',
                'move-done'      => ':count File spostati.',
                'copy-done'      => ':count File copiati.',
                'still-running'  => 'L\'operazione è ancora in esecuzione in background',
            ...
            'upload' => [
                'queued'              => 'In coda',
                'uploading'           => 'Caricamento',
                'creating'            => 'Creazione cartella',
                'done'                => 'Fatto',
                'failed'              => 'Non riuscito',
                'interrupted'         => 'Interrotto — aggiungi di nuovo per riprovare',
                'resuming'            => 'Ripresa…',
                'overall'             => ':done di :total caricati',
                'too-large-to-resume' => 'Lotto troppo grande per la ripresa automatica dopo l\'aggiornamento',
            ],
        ],
    ],
    'share' => [
    ...
    'data-transfer' => [
        'bundle' => [
            ...
            'asset-tree-misnamed'        => 'L\'archivio contiene una cartella denominata ":name" anziché "assets", quindi nessuna delle sue risorse è stata importata. Rinominala in "assets" e mantieni le cartelle sottostanti corrispondenti ai percorsi del file dati, ad esempio "assets/Root/Seed/Tech Sheets/Cotton/". macOS salva una "/" digitata nel nome di una cartella come ":", che è la causa abituale.',
        ],
    ],
];
