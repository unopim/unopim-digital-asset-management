...
return [
        ...
        'dam' => [
            ...
            'index' => [
                ...
                'directory' => [
                    ...
                    'actions' => [
                        ...
                        'add-directory'             => '新增目錄',
                        'upload-files'              => '上傳檔案',
                        'upload-files-and-folders'  => '上傳檔案和資料夾',
                        'upload-folder'             => '上傳資料夾',
                ...
                'folder-upload-no-https-warning' => '沒有安全連線 (HTTPS) 將不會建立空資料夾。檔案仍將被上傳。',
            ...
            'share' => [
                ...
                'modal'            => [
                    ...
                    'active-links'       => '有效連結',
                    'loading'            => '載入中…',
                    'no-active-links'    => '此項目目前沒有有效的共享連結。',
                    'copy'               => '複製',
                    'copied'             => '連結已複製到剪貼簿',
                    'revoke'             => '撤銷',
                    'delete'             => 'Delete',
            ...
            'upload' => [
                ...
                'retry'     => '重試',
                'cancel'    => '取消',
                'paused'    => '上傳已暫停。現有資產不受影響 — 可隨時繼續。',
                'resumed'   => '上傳已繼續。',
                'cancelled' => '上傳已取消。已上傳的資產已保留。',
                'retried'   => '正在背景重試失敗的上傳。',
            ],
            'tag' => [
                'not-found'           => '找不到標籤。',
                ...
                'mass-delete-success' => '已選標籤刪除成功。',
                'index'               => [
                    'title'       => '標籤',
                    'description' => '管理用於標記和組織 DAM 中資產的標籤。',
                    'create'      => '建立標籤',
                ],
                'datagrid' => [
                    'name'         => '名稱',
                ...
                'mass-action' => [
                    'assign-tags'              => '指派標籤',
                    'modal-title'              => '指派標籤',
                    'modal-subtitle'           => '為已選取的 :count 個資產新增標籤。現有標籤將被保留。',
                    'modal-subtitle-recursive' => '為已選取的資產以及所選資料夾內的所有資產遞迴新增標籤。現有標籤將被保留。',
                    'tags-label'               => '標籤',
                    'tags-placeholder'         => '搜尋標籤，或輸入以建立…',
                    'add-tag'                  => '按 Enter 鍵新增',
                    'assign'                   => '指派',
                    'assigning'                => '指派中…',
                    'cancel'                   => '取消',
                    'assign-success'           => '標籤已指派給 :count 個資產。',
                    'assign-failed'            => '標籤指派失敗。',
                    'no-assets'                => '未選取任何資產。',
                    'no-items'                 => '請至少選取一個資產或資料夾。',
                    'no-tags'                  => '請選取或新增至少一個標籤。',
                ],
            ],
        ],
        'catalog' => [
    ...
    'share' => [
        'public' => [
            ...
            'file-type'             => '檔案類型',
            'file-size'             => '檔案大小',
            'video-not-supported'   => '您的瀏覽器不支援 video 標籤。',
            'audio-not-supported'   => '您的瀏覽器不支援 audio 標籤。',
