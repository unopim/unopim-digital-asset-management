...
return [
    'admin' => [
        ...
        'dam' => [
            ...
            'index' => [
                ...
                'directory' => [
                    ...
                    'name-unique'                               => '目錄名稱在同一父目錄中必須唯一。',
                    'folder-upload-success'                     => '資料夾上傳成功。',
                    'folder-upload-partial'                     => '資料夾已上傳，由於錯誤跳過了 :count 個檔案。',
                ],
                ...
                'folder-upload-https-required' => '資料夾上傳需要安全連線 (HTTPS)。',
                'folder-upload-no-files'       => '所選資料夾不包含任何檔案。沒有安全連線 (HTTPS) 無法偵測空子資料夾。',
                'upload-in-progress-title'     => '上傳進行中',
                'upload-in-progress-message'   => '離開此頁面將取消正在進行的上傳。您確定要離開嗎？',
            ...
            'asset' => [
                'properties' => [
                    'index' => [
                        ...
                        'create' => [
                            ...
                            'value'                  => '值',
                            'add-to-filter'          => '新增至篩選',
                            'add-to-filter-help'     => '啟用後，此屬性將作為篩選條件顯示在資產清單側邊欄中。',
                            'sort-order'             => '排序順序',
                            'sort-order-help'        => '數字越小在篩選側邊欄中越靠前。相同數字的屬性按字母順序排列。',
                ...
                'datagrid'                                => [
                    ...
                    'download-link-ready'                 => '已找到資產。您可以從提供的連結下載檔案。',
                ],
            ],
            'share' => [
                ...
                'updated'          => '分享連結已更新。',
                'update-failed'    => '更新分享連結失敗。',
                'delete-failed'    => '刪除分享連結失敗。',
                'modal'            => [
                    'title-asset'        => '共享資產',
                    'title-directory'    => '共享目錄',
                    'edit-title'         => '編輯分享連結',
                    'name-label'         => '自訂名稱',
                    'name-hint'          => '留空以保留原始檔案 / 目錄名稱作為標籤。',
                    'save'               => '儲存變更',
                    'saving'             => '儲存中…',
                    'cancel'             => '取消',
                    'expiry'             => '連結到期時間',
                    ...
                    'reauthorize'        => '重新授權',
                    'reauthorizing'      => '重新授權中…',
                    'reauthorize-failed' => '重新授權分享連結失敗。',
                    'revoked-notice'     => '此連結已撤銷。重新授權以使原始連結重新啟用。',
                ],
                'index' => [
                    'title'       => '共享連結',
                    'description' => 'DAM中資產和目錄的所有有效及歷史共享連結。',
                ],
                'datagrid' => [
                    'type'           => '類型',
                    'asset'          => '資產',
        ...
        'permissions' => [
            ...
            'error'                 => '載入目錄失敗，請重試。',
            'retry'                 => '重試',
            'grants-load-warning'   => '部分目錄授權無法載入，請在儲存前確認您的選擇。',
            'inherit-children-note' => '儲存時將自動包含子目錄。',
        ],
        'validation' => [
            'asset' => [
        ...
        'explorer' => [
            ...
            'context' => [
                ...
                'copy'                 => '複製',
                'paste'                => '貼上',
                'copy-progress'        => '已排入複製佇列。',
                'copy-done'            => '已複製。',
                'paste-file-started'   => '正在貼上檔案...',
                'paste-folder-started' => '正在貼上資料夾...',
                'paste-done'           => '貼上成功。',
                'move-asset-started'   => '正在移動檔案...',
                'move-folder-started'  => '正在移動資料夾...',
                'move-done'            => '資料夾已成功移動。',
                'move-asset-done'      => '檔案已成功移動。',
                'delete-done'          => '目錄已成功刪除。',
            ],
            'folder' => [
                'deleted' => '此資料夾已被刪除 — 已返回根目錄。',
            ],
            'search' => [
            ...
            'mass-actions' => [
                'select-count'   => '已選取 :count 個',
                'select-action'  => '選擇操作',
                'delete'         => '刪除',
                'confirm'        => '刪除 :count 個項目？資料夾將被遞迴刪除且無法復原。',
                'deleting'       => '正在刪除 :count 個項目…',
                'deleted-assets' => '已刪除 :count 個資產。',
                'deleted-dirs'   => ':count 個資料夾已排入刪除佇列。',
                'move-to'        => '移動至…',
                'copy-to'        => '複製至…',
                'moving'         => '正在移動…',
                'copying'        => '正在複製…',
                'moved-assets'   => ':count 個檔案已移動。',
                'copied-assets'  => ':count 個檔案已複製。',
                'moved-dirs'     => ':count 個資料夾已移動。',
                'copied-dirs'    => ':count 個資料夾已複製。',
                'pick-dest'      => '選擇目標資料夾',
                'select-here'    => '在此選擇',
                'new-folder'     => '新增資料夾',
                'folder-name'    => '資料夾名稱',
                'create-error'   => '無法建立資料夾。',
                'move-done'      => ':count 個檔案已移動。',
                'copy-done'      => ':count 個檔案已複製。',
                'still-running'  => '操作仍在背景執行中',
                'progress'       => '進度',
                'total-files'    => ':count 個檔案',
            ],
            'toolbar' => [
                'toggle-tree'    => '切換目錄樹',
            ...
            'upload' => [
                ...
                'done'                => '完成',
                'failed'              => '失敗',
                'interrupted'         => '已中斷 — 重新加入以重試',
                'resuming'            => '正在恢復…',
                'overall'             => '已上傳 :done / :total',
                'too-large-to-resume' => '批次過大，重新整理後無法自動恢復',
            ],
        ],
    ],
    'share' => [
        'public' => [
            'app-name'              => 'DAM',
            'download'              => '下載',
            'back-to-gallery'       => '返回圖庫',
            'back'                  => '返回',
            'file-name'             => '檔案名稱',
            'file-type'             => '檔案類型',
            'file-size'             => '檔案大小',
            'preview-not-available' => '此檔案無法預覽，請使用上方的下載按鈕。',
            'files-count'           => ':count 個檔案',
            'empty-directory'       => '此共享目錄目前沒有任何檔案。',
            'expires-on'            => '此連結的到期時間',
            'powered-by-dam'        => '由 Unopim DAM 提供技術支援',
            'expired-title'         => '連結已到期',
            'expired-message'       => '此共享連結已過期，無法存取。請向擁有者索取新連結。',
            'revoked-title'         => '連結已撤銷',
            'revoked-message'       => '此共享連結已被擁有者撤銷，無法存取。',
            'not-found-title'       => '找不到連結',
