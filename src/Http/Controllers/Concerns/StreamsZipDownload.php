...
trait StreamsZipDownload
{
    ...
    /**
     * Derive the current storage path from the asset's immediate parent directory ID.
     * Returns null when the directories relation is not loaded or yields no result.
     */
